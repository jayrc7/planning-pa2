...
class TestSearch:
    ...
    def test_ball_reachability(self, state, reachable, player):
        ...
        print("predicted reachability: ", predicted_reachable_encoded)
        encoded_reachable = set(board.encode_single_pos(cr) for cr in reachable)
        assert predicted_reachable_encoded == encoded_reachable, \
            "For state {}, predicted reachable positions, {}, not match expected reachable positions, {}".format(state, predicted_reachable_encoded, encoded_reachable)
